...
class tCNN(nn.Module):
    def __init__(self, win_train, num_fb, drop_rate, n_class):
        super(tCNN, self).__init__()
        # AFR
        self.se1 = SELayer(num_fb, 2)
        self.se2 = SELayer(num_fb, 2)
        self.se3 = SELayer(num_fb, 2)
        ...
        # 多尺度卷积
        self.multi_scale_1D = multi_scale_1D(16, 64, 1, 1, drop_rate)
        # 第二个卷积，卷积后的数据格式：16@1X10
        self.conv2 = nn.Conv2d(64, 64, (1, win_train), stride=(5, 5), padding=(0, 23))  # 24也行
