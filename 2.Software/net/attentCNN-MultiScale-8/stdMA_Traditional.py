...
# import stdConfig.stdConfig_FBtCNNDing2021 as Config
...
if __name__ == '__main__':
    # 数据路径
    path_tes_acc_glo_log = './1.0/SubAll_acc_tes_glo_log.mat'
    ...
    acc_mean, acc_std, acc_max_epo_idx = acc_mean_std_multiple_sub_ave_tes(path_tes_acc_glo_log, 7)
    ...
    classes = ['class1', 'class2', 'class3', 'class4','class5', 'class6', 'class7', 'class8']  # 类别
